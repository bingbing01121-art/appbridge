...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
  ...
  Map<String, dynamic> _thumbnailData = {
    'spriteSheetUrl': 'https://i.imgur.com/2zY4000.png', // Example sprite sheet URL
  ...
  void initState() {
    ...
    // Initialize volume
    VolumeController.instance.getVolume().then((volume) => setState(() => _currentVolume = volume));
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return GestureDetector(
              ...
              onVerticalDragUpdate: (details) {
                if (_dragType == _DragType.brightness && !_showBrightnessIndicator) {
                ...
                if (_dragType == _DragType.brightness) {
                  final newBrightness = (_initialBrightness + dragDistance).clamp(0.0, 1.0);
                  ...
                  final newVolume = (_initialVolume + dragDistance).clamp(0.0, 1.0);
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          FutureBuilder<double>(
                                                            ...
                                                            builder: (context, snapshot) {
                                                              return Text('${((snapshot.data ?? 0) * 100).toInt()}%', style: const TextStyle(color: Colors.white));
                                                            },
                                                          ),
                                                        ],
                                                      ),
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          const SizedBox(height: 8),
                                                          Text('${(_currentVolume * 100).toInt()}%', style: const TextStyle(color: Colors.white)),
                                                        ],
                                                      ),
                                                    ),
                                                  ),
                                                                ...
                                                                Positioned(
                                                                  ...
                                                                  child: AnimatedOpacity(
                                                                    ...
                                                                    child: ValueListenableBuilder(
                                                                      valueListenable: _controller,                                                    builder: (context, VideoPlayerValue value, child) {
                                                      // Format duration
                                                      ...
                                                      int thumbnailIndex = (_currentSeekPosition.inSeconds ~/ (_thumbnailData['durationPerThumbnail'] as int)).clamp(0, (_thumbnailData['totalThumbnails'] as int) - 1);
                                                      int row = thumbnailIndex ~/ (_thumbnailData['thumbnailsPerRow'] as int);
                                                      int col = thumbnailIndex % (_thumbnailData['thumbnailsPerRow'] as int);
                            
                                                      double offsetX = col * (_thumbnailData['thumbnailWidth'] as double);
                                                      double offsetY = row * (_thumbnailData['thumbnailHeight'] as double);
                                                          ...
                                                          children: [
                                                            if (_isDragging) // Show thumbnail preview only when dragging
                                                              Container(
                                                                ...
                                                                width: (_thumbnailData['thumbnailWidth'] as double),
                                                                height: (_thumbnailData['thumbnailHeight'] as double),
                                                                decoration: BoxDecoration(
                                                                ...
                                                                child: ClipRect(
                                                                  child: OverflowBox(
                                                                    maxWidth: (_thumbnailData['thumbnailWidth'] as double) * (_thumbnailData['thumbnailsPerRow'] as int),
                                                                    maxHeight: (_thumbnailData['thumbnailHeight'] as double) * ((_thumbnailData['totalThumbnails'] as int) / (_thumbnailData['thumbnailsPerRow'] as int)).ceilToDouble(),
                                                                    child: Transform.translate(
                                                                      offset: Offset(-offsetX, -offsetY),
                                                                      child: CachedNetworkImage(
                                                                        imageUrl: _thumbnailData['spriteSheetUrl'],
                                                                        fit: BoxFit.fill,
                                                            ...
                                                            Row(
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: Text(formatDuration(value.position), style: const TextStyle(color: Colors.white)),
                                                                ),
                                                                Expanded(
                                                                  child: Slider(
                                                                    value: _isDragging ? _currentSeekPosition.inSeconds.toDouble() : value.position.inSeconds.toDouble(),
                                                                    min: 0.0,
                                                                    ...
                                                                    onChanged: (newPosition) {
                                                                      setState(() {
                                                                        _currentSeekPosition = Duration(seconds: newPosition.toInt());
                                                                        _isDragging = true;
                                                                      });
                                                                    },
                                                                    onChangeStart: (startPosition) {
                                                                      ...
                                                                      setState(() {
                                                                        _isDragging = true;
                                                                        _currentSeekPosition = Duration(seconds: startPosition.toInt());
                                                                      });
                                                                    },
                                                                    onChangeEnd: (endPosition) {
                                                                      ...
                                                                      setState(() {
                                                                        _isDragging = false;
                                                                        _controller.seekTo(Duration(seconds: endPosition.toInt()));
                                                                      });
                                                                    },
                                                                  ),
                                                                ),
                                                                Padding(
                                                                  padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                                                  child: Text(formatDuration(value.duration), style: const TextStyle(color: Colors.white)),
                                                                ),
                                                              ],
                                                            ),
                                                          ],
